  ...
  const state = {
    ...
    settings: {
      ...
      configuration: {
        ...
        regionTypesAllowed: ["polygon", "circle", "bounding-box"],
      },
    },
    labelImages: false,
    regionClsList: ["One", "Two"],
    regionColorList: [],
    preselectCls: null,
    regionTagList: [],
    imageClsList: [],
    imageTagList: [],
    currentVideoTime: 0,
    enabledTools: ["create-box", "create-polygon", "create-circle"],
    history: [
      {
