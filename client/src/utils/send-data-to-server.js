...
export const getImageData = (activeImage) => {
  ...
  if (activeImage.pixelSize !== undefined)
    imageData["pixelSize"] = {
      h: activeImage.pixelSize.h,
      w: activeImage.pixelSize.w,
    }
...
export const saveData = (imageData) => {
  return new Promise((resolve, reject) => {
    axios
      .post(`${config.SERVER_URL}/save`, imageData)
      .then((response) => {
...
export const getImagesAnnotation = (imageData) => {
  return new Promise((resolve, reject) => {
    axios
      .post(`${config.SERVER_URL}/get_image_annotations`, imageData)
      .then((response) => {
...
export const saveSettings = (settings) => {
  return new Promise((resolve, reject) => {
    axios
      .post(`${config.SERVER_URL}/settings`, settings)
      .then((response) => {
        resolve(response.data) // Resolve with response data
      })
      .catch((error) => {
